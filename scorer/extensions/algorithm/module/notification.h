...
typedef struct Notification {
  ...
  // If this is the selected notification
  int selected;

  // The timestamp for the last time this notification was selected
  long timestamp;
} Notification;
 ...
 * @param timestamp The last time this notification was selected
 */
...
/**
 * Print the notification list for debugging purposes
 * @param The param list
 */
