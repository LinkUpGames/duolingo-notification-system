...
typedef struct Decision {
  ...
  // The probabilities for each notification in this decision NotificationArray
  NotificationArray *probabilities;

  // The timestamp for when the decision was sent
  long timestamp_sent;

  // The timestamp for when the user accepted/rejected notification in
  // milliseconds
 ...
 * or 0)
 * @param timestamp_sent The decision sent
 * @param timestamp_selected When the decision was selected
 */
...
/**
 * Print the decision list for debugging purposes
